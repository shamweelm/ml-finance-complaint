...
class DataIngestion:
    ...
    def download_data(self, download_url: DownloadUrl):
        try:
            ...
            print("download_url.url", download_url.url)
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        try:
            ...
            print("self.data_ingestion_config.from_date : ", self.data_ingestion_config.from_date)
            print("self.data_ingestion_config.to_date : ", self.data_ingestion_config.to_date)
