...
# accepted_file_path='finance_artifact/data_validation/20230812_151605/accepted_data/finance_complaint', 
# rejected_dir='finance_artifact/data_validation/20230812_151605/rejected_data')
def main():
    try:
        ...
        data_validation_config = DataValidationConfig(accepted_data_dir='finance_artifact/data_validation/20230812_135936/accepted_data', 
                                               rejected_data_dir='finance_artifact/data_validation/20230812_135936/rejected_data', 
                                               file_name='finance_complaint')
        data_validation_artifact = DataValidationArtifact(accepted_file_path='finance_artifact/data_validation/20230812_135936/accepted_data/finance_complaint', 
                               rejected_dir='/finance_artifact/data_validation/20230812_135936/rejected_data')
